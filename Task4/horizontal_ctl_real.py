    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            if self.joyMasterFlag == False:
                ...
                pitch_sp = self.pid_vx.compute(vx_sp, self.vx_mv) #pitch_sp_global = for global frame

                vy_sp = self.pid_y.compute(self.y_sp, self.y_mv)
                roll_sp = -self.pid_vy.compute(vy_sp, self.vy_mv)  #roll_sp_global = for global frame
